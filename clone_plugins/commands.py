...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 Join in our main channel', url='https://t.me/+CK4EXZbq7DRkZmE1')
        ],[
...
# Ask Doubt on telegram @KingVJ01
    ...
    try:
        ...
        title = '@PLAYZ_HACKING ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
